...
class FunctionServer {
    ...
    public static function jugadaServidor(PDO $pdo): ?int { //  ?int hace que puedas devolver un null o un entero. Esta funcion necesita recibir la conexion (PDO) por parametro.
